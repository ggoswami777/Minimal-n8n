...
export default function Sidebar({onExecute,isExecuting, onDelete}:SidebarProps){
    ...
    return(
        <div className='w-80 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 p-4 overflow-y-auto '>
            <div className='mb-6'>
                <h2 className='text-xl font-bold mb-4 text-gray-900 dark:text-white '>Minimal n8n</h2>
                ...
                <div key={category} className='mb-6'>
                    ...
                    <div className='space-y-2'>
                        {groupNodes[category]?.map((node)=>(
                            <div key={node.type} draggable onDragStart={(event)=>onDragStart(event,node.type)} className='p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700  rounded-lg cursor-move hover:shadow-md transition-shadow'>
            ...
            <div className='mt-8 pt-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 p-5'>
